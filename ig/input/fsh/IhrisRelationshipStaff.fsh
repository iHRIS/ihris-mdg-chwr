...
* extension[reportdetails].extension[reportelement][1].extension[order].valueInteger = 0
...
* extension[reportdetails].extension[reportelement][7].extension[fhirpath].valueString = "Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-phone').valueString"
...
* extension[reportdetails].extension[reportelement][7].extension[order].valueInteger = 6

* extension[reportdetails].extension[reportelement][8].extension[name].valueString = "martialStatus"
* extension[reportdetails].extension[reportelement][8].extension[fhirpath].valueString = "Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-marital-status').valueCoding.display"
* extension[reportdetails].extension[reportelement][8].extension[display].valueString = "Marital Status"
...
* extension[reportdetails].extension[reportelement][9].extension[name].valueString = "ihris-related-group"
* extension[reportdetails].extension[reportelement][9].extension[fhirpath].valueString = "Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-related-group').extension.where(url='location').valueString"
...
* extension[reportlink][2].extension[name].valueString = "csb"
...
* extension[reportlink][3].extension[reportelement][0].extension[order].valueInteger = 9