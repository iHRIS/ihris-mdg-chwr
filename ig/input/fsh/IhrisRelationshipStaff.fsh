...
* extension[reportdetails].extension[reportelement][1].extension[fhirpath].valueString = "name.where(use='official').first().given"
...
* extension[reportdetails].extension[reportelement][2].extension[fhirpath].valueString = "name.where(use='official').family"
...
* extension[reportlink][2].extension[reportelement][0].extension[order].valueInteger = 13
...
* extension[reportlink][3].extension[reportelement][0].extension[order].valueInteger = 12
...
* extension[reportlink][4].extension[reportelement][0].extension[order].valueInteger = 11
...
* extension[reportlink][5].extension[reportelement][0].extension[order].valueInteger = 10