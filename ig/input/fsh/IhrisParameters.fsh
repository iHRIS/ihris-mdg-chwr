...
* parameter[=].part[+].name = "site:nav:menu:users:menu:role_roles:text"
* parameter[=].part[=].valueString = "User Roles"
* parameter[=].part[+].name = "site:nav:menu:users:menu:role_roles:url"
...
* parameter[=].part[=].valueString = "Location/MG"
* parameter[=].part[+].name = "defaults:fields:Practitioner.extension:residence.value[x]:valueReference:user_filter:regex"
* parameter[=].part[=].valueString = "related-location=(.+)"
* parameter[=].part[+].name = "defaults:fields:Practitioner.extension:residence.value[x]:valueReference:user_filter:replace"
* parameter[=].part[=].valueString = "$1"
* parameter[=].part[+].name = "defaults:fields:PractitionerRole.extension:commune.value[x]:valueReference:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:PractitionerRole.extension:commune.value[x]:valueReference:initialValue"
* parameter[=].part[=].valueString = "Location/MG"
* parameter[=].part[+].name = "defaults:fields:PractitionerRole.extension:commune.value[x]:valueReference:user_filter:regex"
* parameter[=].part[=].valueString = "related-location=(.+)"
* parameter[=].part[+].name = "defaults:fields:PractitionerRole.extension:commune.value[x]:valueReference:user_filter:replace"
* parameter[=].part[=].valueString = "$1"
...
* parameter[=].part[=].valueString = "Practitioner.name.where(use='official').family + ' ' + Practitioner.name.where(use='official').given"
...
* parameter[=].part[=].valueString = "Practitioner.name.where(use='official').family + ' ' + Practitioner.name.where(use='official').given[0] + ' ' + practitioner.name.where(use='official').given[1]"
