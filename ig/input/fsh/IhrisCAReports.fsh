...
* extension[section][0].extension[field][1].valueString = "extension:careports.extension:month"
* extension[section][0].extension[field][2].valueString = "extension:careports.extension:year"
* extension[section][0].extension[field][3].valueString = "extension:careports.extension:careports"
* extension[section][0].extension[field][4].valueString = "extension:careports.extension:date"
