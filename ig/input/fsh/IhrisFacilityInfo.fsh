...
* item[0].item[0].item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:electricity.value[x]"
...
* item[0].item[0].item[1].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:internet.value[x]"
...
* item[0].item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:fokontany.value[x]"
...
* item[0].item[0].item[3].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:ac.value[x]"
...
* item[0].item[0].item[4].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:inputtools.value[x]"
...
* item[0].item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:tablets.value[x]"
...
* item[0].item[0].item[6].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-facility-info#Basic.extension:facilityInfo.extension:cosan.value[x]"
