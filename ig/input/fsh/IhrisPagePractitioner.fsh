...
* extension[display].extension[search][3].valueString = "Gender|Practitioner.gender|http://ihris.org/fhir/CodeSystem/ihris-gender-codesystem"
...
* extension[display].extension[link][2].extension[url].valueUrl = "/bulk-registration"
* extension[display].extension[link][2].extension[text].valueString = "Upload CSV/Excel"
* extension[display].extension[link][2].extension[displayIn].valueString = "questionnaire"
* extension[display].extension[link][2].extension[button].valueBoolean = true
* extension[display].extension[link][2].extension[icon].valueString = "mdi-attachment"
* extension[display].extension[link][2].extension[class].valueString = "primary"
...
* extension[section][3].extension[resource].extension[searchfieldtarget].valueString = "Practitioner"
...
* extension[section][3].extension[resource].extension[column][5].extension[header].valueString = "Category"
* extension[section][3].extension[resource].extension[column][5].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-category').valueCoding.display"
* extension[section][3].extension[resource].extension[column][6].extension[header].valueString = "Active/Functional"
* extension[section][3].extension[resource].extension[column][6].extension[field].valueString = "PractitionerRole.active"
* extension[section][3].extension[resource].extension[column][7].extension[header].valueString = "Actions"
* extension[section][3].extension[resource].extension[column][7].extension[field].valueString = "_action"
...
* extension[section][4].extension[resource].extension[column][0].extension[header].valueString = "Distance Domicile – Hameau le plus éloigné (km)"
* extension[section][4].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-distance').extension.where(url='village').valueDecimal"
* extension[section][4].extension[resource].extension[column][1].extension[header].valueString = "Distance lieu de travail – CSB (km)"
...
* extension[section][4].extension[resource].extension[column][2].extension[header].valueString = "Distance Domicile - lieu de travail (km)"
* extension[section][4].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-distance').extension.where(url='workplace').valueDecimal"
* extension[section][4].extension[resource].extension[column][3].extension[header].valueString = "Distance CSB – AC le plus éloigné (km) - RC"
* extension[section][4].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-distance').extension.where(url='csbrc').valueDecimal"
...
* extension[section][10].extension[resource].extension[column][2].extension[header].valueString = "Performing"
* extension[section][10].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-supervision').extension.where(url='performing').valueCoding.display"
* extension[section][10].extension[resource].extension[column][3].extension[header].valueString = "Date of Supervision"
* extension[section][10].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-supervision').extension.where(url='date').valueDate"
