...
* extension[reportdetails].extension[reportelement][1].extension[display].valueString = "Monthly AC Grouping"
...
* extension[reportdetails].extension[reportelement][3].extension[type].valueString = "date"
