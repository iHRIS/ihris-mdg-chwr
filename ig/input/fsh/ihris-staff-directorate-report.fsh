...
Instance: ihris-es-report-staff-directorate-mdg
InstanceOf: Basic
Usage: #example
...
* extension.extension[=].extension[+].url = "fhirpath"
* extension.extension[=].extension[=].valueString = "Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-phone').valueString"
* extension.extension[=].extension[+].url = "filter"
* extension.extension[=].extension[=].valueBoolean = true
* extension.extension[=].extension[+].url = "order"
